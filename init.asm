...
main(void)
{
  ...
  52:	e8 99 04 00 00       	call   4f0 <printf>
    printf(1,"Student ID: 2016310932\n");
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
  59:	68 63 08 00 00       	push   $0x863
  5e:	6a 01                	push   $0x1
  60:	e8 8b 04 00 00       	call   4f0 <printf>
    printf(1,"Name: HyunWoong Bae\n");
  65:	59                   	pop    %ecx
  66:	5b                   	pop    %ebx
  67:	68 7b 08 00 00       	push   $0x87b
  6c:	6a 01                	push   $0x1
  ...
  f1:	6a 01                	push   $0x1
  f3:	6a 01                	push   $0x1
  f5:	68 48 08 00 00       	push   $0x848
  fa:	e8 bb 02 00 00       	call   3ba <mknod>
    open("console", O_RDWR);
  ff:	5b                   	pop    %ebx
 100:	58                   	pop    %eax
 101:	6a 02                	push   $0x2
 103:	68 48 08 00 00       	push   $0x848
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb e1 08 00 00       	mov    $0x8e1,%ebx
        while(*s != 0){
